...
public class Limpieza extends Personal {
    ...
    public Limpieza(int id, String identificacion, double salario, String nombre, String primerApellido, LocalDate fechaNacimiento) {
    ...
    public String mostrarInformacion() {
        ...
        s.append("Informacion personal de limpieza " + "\n");
